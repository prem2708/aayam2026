...
export default function HelpPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white pt-24 pb-20 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-[10%] right-[-10%] h-[400px] w-[400px] rounded-full bg-violet-600/5 blur-[150px] -z-10" />
      <div className="absolute bottom-[20%] left-[-10%] h-[400px] w-[400px] rounded-full bg-cyan-600/5 blur-[150px] -z-10" />
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-16">
          <div className="glass rounded-2xl p-6 border border-slate-900 flex flex-col justify-between group hover:border-violet-500/20 transition-all duration-300">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-violet-950/50 border border-violet-500/30 text-violet-400 mb-4">
            ...
            <div>
              ...
              <a href="mailto:support@aayam2026.com" className="text-sm font-semibold text-violet-400 hover:text-violet-300 transition-colors">
                support@aayam2026.com
              </a>
            </div>
          </div>

          <div className="glass rounded-2xl p-6 border border-slate-900 flex flex-col justify-between group hover:border-cyan-500/20 transition-all duration-300">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-cyan-950/50 border border-cyan-500/30 text-cyan-400 mb-4">
            ...
            <div>
              ...
              <a href="https://discord.gg/aayam2026" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-cyan-400 hover:text-cyan-300 transition-colors">
                discord.gg/aayam2026
              </a>
            </div>
          </div>

          <div className="glass rounded-2xl p-6 border border-slate-900 flex flex-col justify-between group hover:border-pink-500/20 transition-all duration-300">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-pink-950/50 border border-pink-500/30 text-pink-400 mb-4">
        ...
        <div className="glass rounded-3xl p-6 sm:p-8 border border-slate-900 mb-16 relative overflow-hidden">
          <div className="absolute top-0 right-0 h-32 w-32 bg-violet-600/5 blur-2xl" />
          <h2 className="text-xl sm:text-2xl font-black font-heading mb-6 text-white flex items-center gap-2">
            <FileCheck className="h-6 w-6 text-violet-400" /> Guide: Registering & Uploading Proof
          </h2>
          <div className="grid gap-6 md:grid-cols-3 text-sm">
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-violet-400 font-bold">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-violet-950 border border-violet-500/30 text-xs">1</span>
                Choose your Event
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-cyan-400 font-bold">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-cyan-950 border border-cyan-500/30 text-xs">2</span>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-pink-400 font-bold">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-pink-950 border border-pink-500/30 text-xs">3</span>
            ...
            {filteredFaqs.map((faq, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span>{faq.q}</span>
                    <ChevronDown className={`h-4 w-4 text-slate-500 transition-transform duration-300 ${isOpen ? 'rotate-180 text-violet-400' : ''}`} />
                  </button>
